	...
	private static void opcoes() {
		if (partida.temPartidaAtiva()) {
			if (partida.verificarVitoria()) {
				...
				System.out
						.println("║  2 - Voltar ao menu principal                                                   ║");
				System.out
						.println("╚═════════════════════════════════════════════════════════════════════════════════╝");
				System.out.println();
			} else {
				System.out
						.println("╔═════════════════════════════════════════════════════════════════════════════════╗");
				System.out
						.println("║  1 - Mover carta                                                                ║");
				System.out
						.println("║  2 - Exibir carta                                                               ║");
				System.out
						.println("║  3 - Alterar nº de cartas a virar do estoque                                    ║");
				System.out
						.println("║  4 - Reiniciar                                                                  ║");
				System.out
						.println("║  5 - Finalizar                                                                  ║");
			...
			if (partida.temPartidaAtiva()) {
				...
				if (partida.verificarVitoria()) {
					...
					if (opcao.equals("1")) {
						...
						String idOrigemString = entrada.next(); // Pega a posição de origem das cartas ou pilha a ser
																// movida
						...
						try {
							...
							String idDestinoString = entrada.next(); // Pega a posição de destino das cartas ou pilha a
																		// ser movida
						...
						System.out.print(
								"> Você realmente quer finalizar a partida? (1 - sim, `Qualquer coisa` - não): ");
						opcao = entrada.next();
